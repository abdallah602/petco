...
<span style="font-family: verdana, geneva, sans-serif"
  ...
  <html lang="en">
    <head>
      <meta charset="UTF-8" />
      <link rel="stylesheet" href="../css_admin/Message_admin.css" />
      <link
        rel="stylesheet"
              ...
              <div class="attendance-list">
                ...
                <table class="table">
                  ...
                  <?php } else{
                    ...
                    <p class="NO_message"> <?php echo "No Messages";?><i class="fac fa-solid fa-comment-slash fa-fade"></i></p> <!--في حاله عدم وجود رسايل-->
